...
def test_exactmatch_skill_extractor_candidate_skills():
    ...
    assert sample_job_posting()['description'][candidate_skills[0].start_index:candidate_skills[0].start_index + 7].lower() == 'cooking'
    ...
    assert sample_job_posting()['description'][candidate_skills[1].start_index:candidate_skills[1].start_index + 12].lower() == 'organization'
