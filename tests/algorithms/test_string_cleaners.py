...
class TestStringCleaners(unittest.TestCase):
    ...
    def test_section_extract(self):
        ...
        for sentence, start_index in section_units:
            assert sentence[0:5] == document[start_index:start_index+5]
        for expected_section in expected_sections:
            assert any(section[0] == expected_section for section in section_units)
